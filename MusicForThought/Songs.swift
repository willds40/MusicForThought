class Songs{
    ...
    //Rock Songs
    var help = ["id":3, "name":"Help!", "Description":"I need somebody, pleaseeee...", "Cover Art":"www.BeatlesForever.com"] as [String : Any]
    
    var imagine = ["id":4, "name":"Imagine", "Description":"World Peace", "Cover Art":"www.IAmStillAlive.com"] as [String : Any]
